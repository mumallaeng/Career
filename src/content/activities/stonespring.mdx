...
**설계 자료**
- [Software Requirement Specification (SRS)](./stonespring/software_requirements_specification.md)
- [Interface Specification](https://github.com/addinedu-ros-8th/deeplearning-repo-3/wiki/Interface-Specification)
    - [Login/Signup](./stonespring/interface_specification/01.%20login,signup.md)
    - [Chat Message](./stonespring/interface_specification/02.%20chat_message.md)
    - [User Emotion Analysis Result](./stonespring/interface_specification/03.%20User%20Emotion%20Analysis%20Result.md)
    - [Pet Character Setting](./stonespring/interface_specification/04.%20Pet%20Character%20Setting.md)
    - [Pet Training Setting](./stonespring/interface_specification/05.%20Pet%20Training%20Setting.md)
    - [Gesture Event](./stonespring/interface_specification/06.%20Gesture%20Event.md)
    - [User Setting](./stonespring/interface_specification/07.%20User%20Setting.md)
    - [Log](./stonespring/interface_specification/08.%20Log.md)
    - [Video Stream](./stonespring/interface_specification/09.%20Video%20Stream.md)
    - [Audio Stream](./stonespring/interface_specification/10.%20Audio%20Stream.md)
- [Sequence Diagrams](./stonespring/Sequence%20Diagram.md)
    - [System Initialization](./stonespring/Sequence%20Diagram/1.%20System%20Initialization.md)
    - [User Request Flow](./stonespring/Sequence%20Diagram/2.%20User%20Request%20Flow.md)
    - [Server Request Handling](./stonespring/Sequence%20Diagram/3.%20Server%20Request%20Handling.md)
    - [AI Processing Flow](./stonespring/Sequence%20Diagram/4.%20AI%20Processing%20Flow.md)
    - [Response Flow](./stonespring/Sequence%20Diagram/5.%20Response%20Flow.md)
- [Diagrams](./stonespring/Diagram.md)
- [GUI Specification](./stonespring/gui_specification.md)
...
[참고 자료](./stonespring/database_structure.md)
